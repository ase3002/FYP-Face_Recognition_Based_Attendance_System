...
namespace MultiFaceRec
{
    ...
    { 
        ...
        string[] images_CDS1 = Directory.GetFiles(Application.StartupPath + "\\Celebrity_Data_Set_1_Testing_Images\\");
        string[] images_CDS2 = Directory.GetFiles(Application.StartupPath + "\\Celebrity_Data_Set_2_Testing_Images\\");
        string[] images_CDS3 = Directory.GetFiles(Application.StartupPath + "\\Celebrity_Data_Set_3_Testing_Images\\");
        ...
        int counter_SDS3 = 0;
        //Counter to iterate through the images in Celebrity data set 1
        int counter_CDS1 = 0;
        //Counter to iterate through the images in Celebrity data set 2
        int counter_CDS2 = 0;
        //Counter to iterate through the images in Celebrity data set 3
        int counter_CDS3 = 0;
        ...
        private void btnLoadImageFromDatabase_Click(object sender, EventArgs e)
        {
            ...
            images_CDS1 = Directory.GetFiles(Application.StartupPath + "\\Celebrity_Data_Set_1_Testing_Images\\");
            images_CDS2 = Directory.GetFiles(Application.StartupPath + "\\Celebrity_Data_Set_2_Testing_Images\\");
            images_CDS3 = Directory.GetFiles(Application.StartupPath + "\\Celebrity_Data_Set_3_Testing_Images\\");
            ...
            else if (cmb_Select_Data_Set.Text == "Student Data Set 3")
            {
                ...
                {
                total_number_of_testing_images = images_CDS1.Length;
                try
                {
                    //==========================Obtain the images from the student dataset=================//
                    Image image_from_file = Image.FromFile(images_CDS1[counter_CDS1]);
                    ImageFrame = new Image<Bgr, byte>((Bitmap)image_from_file);
                    CamImageBox.Image = ImageFrame;
                    Image_File_Name = Path.GetFileName(images_CDS1[counter_CDS1]);
                    int index = Image_File_Name.IndexOfAny("_0123456789".ToCharArray());
                    string extracted_training_label = Image_File_Name.Substring(0, index);
                    if (index > 0)
                    {
                    ...
                    /* Bitmap BmpImgFrame2 = new Bitmap(ImageFrame2.Bitmap);
                     picTestingImage.Image = (Image)BmpImgFrame2;*/
                    if (counter_CDS1 < images_CDS1.Length - 1)
                    {
                        counter_CDS1 = counter_CDS1+ 1;
                        lblTestingImgNo.Text = Convert.ToString(counter_CDS1);
                    }
                    else
                    {
                        counter_CDS1 = 0;
            ...
            {
                //counter_CDS2 = 50;
                total_number_of_testing_images = images_CDS2.Length;
                try
                {
                    //==========================Obtain the images from the student dataset=================//
                    Image image_from_file = Image.FromFile(images_CDS2[counter_CDS2]);
                    ImageFrame = new Image<Bgr, byte>((Bitmap)image_from_file);
                    CamImageBox.Image = ImageFrame;
                    Image_File_Name = Path.GetFileName(images_CDS2[counter_CDS2]);
                    int index = Image_File_Name.IndexOfAny("_0123456789".ToCharArray());
                    string extracted_training_label = Image_File_Name.Substring(0, index);
                    if (index > 0)
                    {
                    ...
                    /* Bitmap BmpImgFrame2 = new Bitmap(ImageFrame2.Bitmap);
                     picTestingImage.Image = (Image)BmpImgFrame2;*/
                    if (counter_CDS2 < images_CDS2.Length - 1)
                    {
                        counter_CDS2 = counter_CDS2 + 1;
                        lblTestingImgNo.Text = Convert.ToString(counter_CDS2);
                    }
                    else
                    {
                        counter_CDS2 = 0;
            ...
            {
                total_number_of_testing_images = images_CDS3.Length;
                try
                {
                    //==========================Obtain the images from the student dataset=================//
                    Image image_from_file = Image.FromFile(images_CDS3[counter_CDS3]);
                    ImageFrame = new Image<Bgr, byte>((Bitmap)image_from_file);
                    CamImageBox.Image = ImageFrame;
                    Image_File_Name = Path.GetFileName(images_CDS3[counter_CDS3]);
                    int index = Image_File_Name.IndexOfAny("_0123456789".ToCharArray());
                    string extracted_training_label = Image_File_Name.Substring(0, index);
                    if (index > 0)
                    {
                    ...
                    /* Bitmap BmpImgFrame2 = new Bitmap(ImageFrame2.Bitmap);
                     picTestingImage.Image = (Image)BmpImgFrame2;*/
                    if (counter_CDS3 < images_CDS3.Length - 1)
                    {
                        counter_CDS3 = counter_CDS3 + 1;
                        lblTestingImgNo.Text = Convert.ToString(counter_CDS3);
                    }
                    else
                    {
                        counter_CDS3 = 0;
            ...
            else if (cmb_Select_Data_Set.Text == "Celebrity Data Set 1")
            {
                ...
                else
                {
                    try
                    {
                        if (ImageFrame != null)
                        {
                            ImageFrame.Save(Application.StartupPath + "\\Celebrity_Data_Set_1_Testing_Images\\" + txtImageFileName.Text);
                            MessageBox.Show(lblTestingImageName.Text + "'s image is being saved successfully");                     
                            lblTestingImgNo.Text = Convert.ToString((images_CDS1.Length)+1);
                        }
                    }
                    catch (Exception ex)
                    {
            ...
            else if (cmb_Select_Data_Set.Text == "Celebrity Data Set 2")
            {
                ...
                else
                {
                    try
                    {
                        if (ImageFrame != null)
                        {
                            ImageFrame.Save(Application.StartupPath + "\\Celebrity_Data_Set_2_Testing_Images\\" + txtImageFileName.Text);
                            MessageBox.Show(lblTestingImageName.Text + "'s image is being saved successfully");
                            lblTestingImgNo.Text = Convert.ToString((images_CDS2.Length)+1);
                        }
                    }
                    catch (Exception ex)
                    {
            ...
            else if (cmb_Select_Data_Set.Text == "Celebrity Data Set 3")
            {
                ...
                else
                {
                    try
                    {
                        if (ImageFrame != null)
                        {
                            ImageFrame.Save(Application.StartupPath + "\\Celebrity_Data_Set_3_Testing_Images\\" + txtImageFileName.Text);
                            MessageBox.Show(lblTestingImageName.Text + "'s image is being saved successfully");
                            lblTestingImgNo.Text = Convert.ToString((images_CDS3.Length) + 1);
                        }
                    }
                    catch (Exception ex)
                    {
